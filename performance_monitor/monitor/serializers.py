...
class PermissionSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        extra_kwargs = {"id": {"read_only": True},
                        "content_type": {"read_only": True}, "codename": {"read_only": True}}
...
class GroupsSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance: Group):
        ...
        ret['permissions'] = PermissionSerializer(
            instance.permissions.all(), many=True).data
        return ret
...
class ListUserAccountSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        if User.objects.filter(email=email).exists():
            ...
            service_locator.core_service.send_email(
                ...
                template_context={
                    "user": user,
                    "password_reset_link": f"{base_url}{reset_password_link}",
